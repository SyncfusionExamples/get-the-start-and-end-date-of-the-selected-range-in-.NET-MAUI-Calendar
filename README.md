...
This repository contains a sample of how to get the start and end date of the selected range in the [SfCalendar](https://help.syncfusion.com/maui/calendar/getting-started) control.

Please refer the KB through this [link](https://www.syncfusion.com/kb/13829/how-to-get-start-and-end-dates-in-the-net-maui-calendar-sfcalendar).
